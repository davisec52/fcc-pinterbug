...
const {isValidUrl, isAuthenticated, processPin} = require("../helpers/auxiliary");
...
router.post("/img-selection/:id/:query", isAuthenticated, (req, res) => {
	console.log("req.body: ", req.body);
...
router.get("/dashboard/:id/:query", isAuthenticated, (req, res, next) => {
	let q = querystring.parse(req.params.query);
	let save = q.save;
...
router.get("/user-board/:id/:query", isAuthenticated, (req, res) => {
	let q = querystring.parse(req.params.query);
	console.log("q: ", q);
...
router.post("/user-image/:id/:query", isAuthenticated, isValidUrl, (req,res) => {
	let timestamp = new Date;
...
router.get("/user-pins/:id", isAuthenticated, (req, res) => {
...
router.post("/delete-img/:id/:imageId/:query", isAuthenticated, (req, res) => {
...
router.post("/delete-pin/:id/:imageId/:query", isAuthenticated, (req, res) => {
	let q = querystring.parse(req.params.query);
...
router.post("/delete-board/:id/:query", isAuthenticated, (req, res) => {
	let q = querystring.parse(req.params.query);
...
router.get("/pin/:id/:query", isAuthenticated, (req, res) => {
	let q = querystring.parse(req.params.query);
	let bi = q.boardindex;
	let ii = q.imageindex;
...
router.post("/pin/:id/:query", isAuthenticated, (req, res) => {
	let boardName;
	let userBoards;
	let q = querystring.parse(req.params.query);
